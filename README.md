...
1. Download and install <a href="[https://example.com](https://www.anaconda.com/download)" target="_blank">

Anaconda</a>[Anaconda](https://www.anaconda.com/download) or [Miniconda](https://docs.anaconda.com/miniconda/).
